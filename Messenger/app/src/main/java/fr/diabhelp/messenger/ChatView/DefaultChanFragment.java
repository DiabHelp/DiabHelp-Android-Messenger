...
public class DefaultChanFragment extends Fragment {
    ...
    {
        DefaultChanFragment myFragment = new DefaultChanFragment();
        return myFragment;
    }
...
//        companionLabel.setText("My Buddy");// Hard Coded
        meLabel.setText("On this room we speak about life of diabetic");
        loadDummyHistory();
